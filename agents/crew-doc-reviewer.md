...
else — no writing, no shell. If you need a command run, say so in your report and
the product manager (PM) will run it. The PM started you and is the only one you
talk to.
...
the blocking findings from that list, plus any new problem the fixes caused. Do
